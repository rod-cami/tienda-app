...
import { faCartShopping, faIdCardClip, faPerson, faWallet, faXmark } from '@fortawesome/free-solid-svg-icons'
...
export const SaleInformation = (): JSX.Element => {
  ...
  // Show modal
  const handleShow = (card: boolean): void => {
    setCard(card)
    setShow(!show)
  }
        ...
        <div className="min-w-0 flex-1">
          <div className='row m-0 p-0'>
            ...
            <div className="flex justify-end col-6">
              ...
              <span className="sm:ml-3">
                ...
                >
                   <FontAwesomeIcon className="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400" icon={faWallet} />
                  Agregar Tarjeta
                </button>
              </span>
              <span className="sm:ml-3">
          ...
          <div className="mt-3 ml-3 flex justify-between sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
            ...
            <div className="mt-2 flex items-center text-sm text-gray-500">
              ...
              {branch.nombre} - {sale.puntoDeVenta.numeroPtoVenta}
            </div>
            <div className="mt-2 flex items-center text-sm text-gray-500">
